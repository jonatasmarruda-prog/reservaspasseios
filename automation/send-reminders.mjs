...
const targets=[
  {days:3,field:'reminder_3d_sent_at',subject:migrateTemplate(settings.reminder_3d_subject,LEGACY_3D_SUBJECT,defaults.reminder_3d_subject),body:migrateTemplate(settings.reminder_3d_body,LEGACY_3D_BODY,defaults.reminder_3d_body),label:'3 dias antes'},
  {days:1,field:'reminder_1d_sent_at',subject:migrateTemplate(settings.reminder_1d_subject,LEGACY_1D_SUBJECT,defaults.reminder_1d_subject),body:migrateTemplate(settings.reminder_1d_body,LEGACY_1D_BODY,defaults.reminder_1d_body),label:'1 dia antes'},
  ...
  for(const tripDoc of tripsSnap.docs){
    ...
    for(const rDoc of reservations.docs){
      ...
      const vars={
        ...
        saida:trip.departure_time||'',participantes:participants,levar:trip.what_to_bring||'',lembrete_extra:trip.reminder_notes||'',
