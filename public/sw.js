const CACHE='trilheiros-admin-v6-20260909';
const APP_SHELL=['/','/admin','/offline.html','/manifest.webmanifest','/app.css','/premium.css','/features-v2.css','/public-premium.css','/public-flow-v3.css','/public-polish-v5.css','/admin-v6.css','/spark.js','/admin-fix.js','/features-v2.js','/public-premium.js','/public-flow-v4.js','/public-polish-v5.js','/preboot.js','/pwa.js','/admin-v6.js','/app-icon-192.svg','/app-icon-512.svg'];
