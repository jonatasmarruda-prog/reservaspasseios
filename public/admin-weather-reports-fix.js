...
function schedule(){clearTimeout(renderTimer);renderTimer=setTimeout(()=>{injectStyle();repairReports();mountHomeWeather();mountTripsWeather()},120)}
