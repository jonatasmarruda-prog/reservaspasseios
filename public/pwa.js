...
(function(){
  ...
  const NOTIFICATION_ICON='https://trilheiros-reservas.web.app/assets/trilheiros-logo-email.png?v=20260925-hosted1';
  ...
  async function registerServiceWorker(){
    ...
    try{
      swRegistration=await navigator.serviceWorker.register('/sw.js?v=20260925-hosted-logo1',{updateViaCache:'none'});
